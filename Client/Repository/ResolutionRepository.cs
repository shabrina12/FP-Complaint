...
{
    public class ResolutionRepository : GeneralRepository<Resolution, int>, IResolutionRepository
    {
		...
		public async Task<ResponseMessageVM> PostResolution(ResolutionVM entity, string token)
		{
